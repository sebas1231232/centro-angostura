      ...
      {isAdmin && (
        <div className="absolute top-4 left-4 flex flex-col gap-2 z-10">
          ...
          >
            {/* Icono Eliminar */}
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
              <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12.54 0c.04.03.079.062.118.095m-1.18-.095a48.145 48.145 0 0 1-3.478-.397m15.708 0-1.08-1.173A1.125 1.125 0 0 0 16.31 4.23l-1.32.378m-1.32-.378L12.9 3.12a1.125 1.125 0 0 0-1.8 0L9.81 4.23m-1.32.378-1.08 1.173A1.125 1.125 0 0 0 6.19 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12.54 0c.04.03.079.062.118.095m-1.18-.095a48.145 48.145 0 0 1-3.478-.397M15 8.25v9.75M8.25 8.25v9.75" />
            </svg>
          </button>
        </div>
      )}
